...
namespace stan {
  namespace interface_callbacks {
    namespace writer {
      ...
      /**
       * jsonlines_stream_writer_writer writes to an std::ostream.
       */
      class jsonlines_stream_writer_writer : public base_writer {
      public:
        /**
         * Constructor.
         *
         ...
         *   treated as comments.
         */
        jsonlines_stream_writer_writer(std::ostream& output,
...
//        std::ostream& output__;
        ...
        bool write_delimited_pb(
          ...
          // FIXME: Find the to-JSON API, implement here, rest stays
          // the same.  There's a lot of duplicated code above so...
          // fix duplication sometime...
